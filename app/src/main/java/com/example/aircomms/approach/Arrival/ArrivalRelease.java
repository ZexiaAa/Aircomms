...
public class ArrivalRelease extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPref.loadNightModeState()){
            ...
            window.setStatusBarColor(ContextCompat.getColor(ArrivalRelease.this, R.color.bg));
        }else {
        ...
        setContentView(R.layout.activity_arrival_release);
        history();
    ...
    public void back_release(View view) {
        startActivity(new Intent(ArrivalRelease.this, ApproachControl.class));
    }
}