...
public class Departure extends AppCompatActivity {
    ...
    private void manageFlightStrip(int clickedItem) {
        ...
        TextView text_6 = (TextView) flightStripContent_6;
        TextView text_7 = (TextView) flightStripContent_7;
        TextView text_8 = (TextView) flightStripContent_8;
        TextView text_10 = (TextView) flightStripContent_10;
        ...
        switch (clickedItem) {
            ...
            default:
                ...
                //Strikethrough Text
                text_6.setPaintFlags(text_6.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
                text_7.setPaintFlags(text_7.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
                text_8.setPaintFlags(text_8.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
                text_10.setPaintFlags(text_10.getPaintFlags() & (~Paint.STRIKE_THRU_TEXT_FLAG));
                break;
            case 2:
    ...
    public void approachControl_departure_expand1(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_1);
        audioController(view.findViewById(R.id.list_1),R.raw.departure1);
    ...
    public void approachControl_departure_expand2(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_2);
        audioController(view.findViewById(R.id.list_2),R.raw.departure2);
    ...
    public void approachControl_departure_expand3(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_3);
        audioController(view.findViewById(R.id.list_3),R.raw.departure3);
    ...
    public void approachControl_departure_expand4(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_4);
        audioController(view.findViewById(R.id.list_4),R.raw.departure4);
    ...
    public void approachControl_departure_expand5(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_5);
        audioController(view.findViewById(R.id.list_5),R.raw.departure5);
    ...
    public void approachControl_departure_expand6(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_6);
        audioController(view.findViewById(R.id.list_6),R.raw.departure6);
    ...
    public void approachControl_departure_expand7(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_7);
        audioController(view.findViewById(R.id.list_7),R.raw.departure7);
    ...
    public void approachControl_departure_expand8(View view) {
        //Controls Audio
        audioProgressBar = view.findViewById(R.id.progressBar_8);
        audioController(view.findViewById(R.id.list_8),R.raw.departure8);
    ...
    public void approachControl_departure_back(View view) {
        onBackPressed();
    }

    public void approachControl_departure_flightStrip(View view) {
        //Shows or Hides Flight Strip
        setVisibility(findViewById(R.id.departureFSContent),findViewById(R.id.departureFSLayout));
    }

    public void approachControl_departure_pseudoTMA(View view) {
